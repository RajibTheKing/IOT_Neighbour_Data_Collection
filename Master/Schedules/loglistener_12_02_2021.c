...
receiver_of_flow[2] = 2;
  ...
  first_tx_slot_in_flow[0][6] = 132;
  last_tx_slot_in_flow[0][6] = 133;
  ...
  last_tx_slot_in_flow[1][0] = 2;
  first_tx_slot_in_flow[1][1] = 27;
  last_tx_slot_in_flow[1][1] = 27;
  first_tx_slot_in_flow[1][2] = 53;
  last_tx_slot_in_flow[1][2] = 53;
  first_tx_slot_in_flow[1][3] = 79;
  last_tx_slot_in_flow[1][3] = 79;
  first_tx_slot_in_flow[1][4] = 105;
  last_tx_slot_in_flow[1][4] = 105;
  first_tx_slot_in_flow[1][5] = 131;
  last_tx_slot_in_flow[1][5] = 131;
  first_tx_slot_in_flow[1][6] = 157;
  last_tx_slot_in_flow[1][6] = 157;
  first_tx_slot_in_flow[1][7] = 183;
  last_tx_slot_in_flow[1][7] = 183;
  first_tx_slot_in_flow[1][8] = 209;
  last_tx_slot_in_flow[1][8] = 209;
  first_tx_slot_in_flow[1][9] = 235;
  last_tx_slot_in_flow[1][9] = 235;
  first_tx_slot_in_flow[1][10] = 261;
  last_tx_slot_in_flow[1][10] = 261;
...
if (node_id == 2){
  ...
  add_links(add_link, 37, cha_idx, cha_idx_to, 1);
